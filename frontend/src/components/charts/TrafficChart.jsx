        ...
        <div className="p-4">
            ...
            <ResponsiveContainer width="100%" height={300}>
                <ComposedChart data={data}>
                    ...
                    <YAxis yAxisId="count" orientation="left" label={{value: 'Request Count', angle: -90, position: 'insideLeft'}}/>
                    <YAxis yAxisId="latency" orientation="right" label={{value: 'Latency (s)', angle: 90, position: 'insideRight'}}/>
                    <Tooltip/>
                    <Legend/>
